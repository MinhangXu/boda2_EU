...
# GPU-parallel launcher for the comparable-bin log-grid follow-up.
# The default cap is 1000, so fractions become N ~= 10, 20, 50, 100, 200, 500, 1000.
...
OUTDIR="${OUTDIR:-${REPO_ROOT}/boda2_EU/src/finetune/learning_curve/lib1_enhancer_barcode_range_comparable_bins_loggrid_hq4_hq8_cap1000_b2_b3_bcap10_may2026}"
...
SETTING_FLAGS="${SETTING_FLAGS:---include_b2 --include_b3}"
