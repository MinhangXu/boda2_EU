...
CONFIG_PATH="configs/utr3/hani_rna_activity/resnet1d/utr3__hani_rna_activity__resnet1d__cell_conditioned_delta_aux_bayes.yml"
TASK_FAMILY="utr3"
TARGET_FAMILY="hani_rna_activity_cell_conditioned_delta_aux"
COMPARISON_GROUP="utr3__hani_rna_activity__cell_conditioned_delta_aux_resnet1d"
LAUNCH_SCRIPT="launch/utr3_hani_resnet1d_cell_conditioned_delta_aux_sweep.sh"
