...
CONFIG_PATH="configs/utr3/bashor_in_house/utr_bassetvl/lib1_threeprime__scratch_utr_bassetvl__bayes.yml"
TASK_FAMILY="utr3"
TARGET_FAMILY="bashor_in_house_threeprime_modal100_fastqs1_5"
COMPARISON_GROUP="utr3__bashor_in_house__threeprime_modal100__scratch_utr_bassetvl_fp32"
LAUNCH_SCRIPT="launch/lib1_threeprime_scratch_utr_bassetvl_sweep.sh"
...
if [[ "${DRY_RUN}" == "1" ]]; then
  echo "LIB1 THREEPRIME SCRATCH UTR_BASSETVL HPO"
