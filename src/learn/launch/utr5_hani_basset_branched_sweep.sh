...
CONFIG_PATH="configs/utr5/hani_rna_activity/basset_branched/utr5__hani_rna_activity__basset_branched__bayes.yml"
TASK_FAMILY="utr5"
TARGET_FAMILY="hani_rna_activity"
COMPARISON_GROUP="utr5__hani_rna_activity__observed_head_branched"
LAUNCH_SCRIPT="launch/utr5_hani_basset_branched_sweep.sh"
