...
CONFIG_PATH="configs/utr5/hani_rna_activity/basset_branched/utr5__hani_rna_activity__basset_branched__delta_aux_bayes.yml"
TASK_FAMILY="utr5"
TARGET_FAMILY="hani_rna_activity_delta_aux"
COMPARISON_GROUP="utr5__hani_rna_activity__observed_head_branched_delta_aux"
LAUNCH_SCRIPT="launch/utr5_hani_basset_branched_delta_aux_sweep.sh"
