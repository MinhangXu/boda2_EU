...
CONFIG_PATH="configs/utr3/hani_rna_activity/resnet1d/utr3__hani_rna_activity__resnet1d__focused_bayes.yml"
TASK_FAMILY="utr3"
TARGET_FAMILY="hani_rna_activity"
COMPARISON_GROUP="utr3__hani_rna_activity__observed_head_resnet1d_focused_stage2"
LAUNCH_SCRIPT="launch/utr3_hani_resnet1d_focused_sweep.sh"
