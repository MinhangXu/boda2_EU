...
CONFIG_PATH="configs/utr3/hani_rna_activity/basset_branched/utr3__hani_rna_activity__basset_branched__delta_aux_bayes.yml"
TASK_FAMILY="utr3"
TARGET_FAMILY="hani_rna_activity_delta_aux"
COMPARISON_GROUP="utr3__hani_rna_activity__observed_head_branched_delta_aux"
LAUNCH_SCRIPT="launch/utr3_hani_basset_branched_delta_aux_sweep.sh"
