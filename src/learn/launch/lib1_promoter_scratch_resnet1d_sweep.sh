...
SOURCE_DATA="/home/minhang/synBio_AL/opt_EU_learn_n_design/MattLee_lib1/promoters/L1_final_fastqs1-5_sublibrary_Promoter_subset.csv"
...
if [[ "${DRY_RUN}" == "1" ]]; then
  echo "LIB1 PROMOTER SCRATCH RESNET1D HPO"
