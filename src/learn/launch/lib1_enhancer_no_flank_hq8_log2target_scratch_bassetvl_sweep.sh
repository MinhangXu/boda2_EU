...
CONFIG_PATH="configs/enhancer/bashor_in_house/bassetvl/lib1_enhancer_no_flank_hq8_log2target__scratch_bassetvl__bayes.yml"
TASK_FAMILY="enhancer"
TARGET_FAMILY="bashor_in_house_lib1_enhancer_no_flank_hq8_fastqs1_5_log2_rna_dna"
COMPARISON_GROUP="enhancer__bashor_in_house__no_flank_hq8_log2target__scratch_bassetvl_fp32"
LAUNCH_SCRIPT="launch/lib1_enhancer_no_flank_hq8_log2target_scratch_bassetvl_sweep.sh"
...
if [[ "${DRY_RUN}" == "1" ]]; then
  echo "LIB1 ENHANCER NO-FLANK HQ8 LOG2-TARGET SCRATCH BASSETVL HPO"
