...
| [x] | 2026-04-19 to 2026-05-04 | `src/learn/outputs/hpo_runs/by_project/enhancer__bashor_in_house__*` | `src/learn/configs/enhancer/bashor_in_house/*.yml`, `src/learn/launch/lib1_enhancer*scratch*.sh` | `archive/lib1_scratch_basic_sweep_diagnostics_and_test_eval.ipynb`; duplicate root-level `lib1_scratch_basic_sweep_diagnostics_and_test_eval.ipynb` remains outside this folder | From-scratch enhancer training does not generalize well enough to be primary path. | Archive thematic copy; use rehydration plan as canonical. | thematic copy moved to local archive | generated HPO roots stay ignored; delete only after registry/plan recap is trusted |
